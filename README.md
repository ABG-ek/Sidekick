...
Исходный код прототипа размещен в отдельном приватном репозитории GitHub:  
https://github.com/ABG-ek/sidekick-extractors

Доступ предоставляется членам комиссии индивидуально по GitHub-аккаунтам в связи с ограничением публичного раскрытия материалов, относящихся к результатам интеллектуальной деятельности.
